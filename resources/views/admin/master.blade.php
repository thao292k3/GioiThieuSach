        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-library"></span><span class="mtext">Quản lý sách </span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{route('book.index')}}">Danh sách Book</a></li>
                            <li><a href="{{route('book.create')}}">Thêm mới sách</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-library"></span><span class="mtext">Quản lý liên hệ </span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-paint-brush"></span><span class="mtext">Quản lý bài viết </span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{route('blog.index')}}">Danh sách bài viết </a></li>
                            <li><a href="{{route('blog.create')}}">Thêm mới bài viết </a></li>
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-apartment"></span><span class="mtext">Quản lý người dùng </span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-analytics-21"></span><span class="mtext">Quản lý bình luận </span>
                        </a>
                        <ul class="submenu">
                    ...
                    <li class="dropdown">
                        <a href="javascript:;" class="dropdown-toggle">
                            <span class="micon dw dw-apartment"></span><span class="mtext">Quản lý sách yêu thích </span>
                        </a>
                        <ul class="submenu">
                            <li><a href="{{route('favorites.index')}}">Danh sách yêu thích </a></li>
